...
public class RdbSchema extends Schema<RedDatabase, RdbTable> {

    public RdbSchema(JdbcTemplate jdbcTemplate, RedDatabase database, String name) {
    ...
    @Override
    protected RdbTable[] doAllTables() throws SQLException {
        ...
        RdbTable[] tables = new RdbTable[tableNames.size()];
    ...
    @Override
    public RdbTable getTable(String tableName) {
        return new RdbTable(jdbcTemplate, database, this, tableName);
    }
}